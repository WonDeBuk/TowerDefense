...
Hornet::Hornet() {
	...
	EnemyDrawbox = { EnemyCurrentPosition.x - EnemyTextureSize.x / 2, EnemyCurrentPosition.y - EnemyTextureSize.y * 4 / 5, EnemyTextureSize.x, EnemyTextureSize.y };
...
void Hornet::Draw() const {
	DrawTexturePro(*EnemyTexture, { 256.0f * EnemyFrameState, 0.0f, 256.0f * CurrentAnimationState, 256.0f }, EnemyDrawbox, { 0.0f, 0.0f }, 0.0f, WHITE);
