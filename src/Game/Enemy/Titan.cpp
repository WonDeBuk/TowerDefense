...
Titan::Titan() {
	...
	EnemyLifespan = 500;
	AbilityCooldown = 600;
	EnemyHitbox = { EnemyCurrentPosition.x - 48.0f, EnemyCurrentPosition.y - 0.94f * 126.0f, 96.0f, 126.0f };
...
void Titan::Update() {
	...
	EnemyHitbox.y = EnemyCurrentPosition.y - EnemyHitbox.height * 0.94f;
