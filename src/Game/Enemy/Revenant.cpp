...
Revenant::Revenant() {
	...
	EnemyHitbox = { EnemyCurrentPosition.x - 48.0f, EnemyCurrentPosition.y - 0.91f * 160.0f, 96.0f, 160.0f };
...
void Revenant::Update() {
	...
	EnemyHitbox.y = EnemyCurrentPosition.y - EnemyHitbox.height * 0.91f;
