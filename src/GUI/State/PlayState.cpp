...
void PlayState::Update()
{
    ...
    if (CheckCollisionPointRec(MousePosition, ForestMap) && IsMouseButtonPressed(MOUSE_LEFT_BUTTON)) {
        SoundManager::GetInstance().PlaySFX("click.ogg");
    ...
    if (CheckCollisionPointRec(MousePosition, FrozenMap) && IsMouseButtonPressed(MOUSE_LEFT_BUTTON)) {
        SoundManager::GetInstance().PlaySFX("click.ogg");
        GameManager::GetInstance().ResetConfig();
